...
.hextra-card-image + div .hextra-card-icon { font-size: 1.125rem; }
.hextra-cards > a:last-child:nth-child(odd) {
  grid-column: 1 / -1;
  justify-self: center;
...
<div style="display: flex; gap: 0.6rem; flex-wrap: wrap; margin: 0.5rem 0 1.5rem;">
  <span style="padding: 0.3rem 0.9rem; border-radius: 9999px; border: 2.5px solid #E53935; color: #E53935; font-size: 0.92rem; font-weight: 500;">Yuan Jack Yao</span>
  ...
  <span style="padding: 0.3rem 0.9rem; border-radius: 9999px; border: 2.5px solid #B8860B; color: #B8860B; font-size: 0.92rem; font-weight: 500;">MSA @ School of CSE, Georgia Tech</span>
</div>
...
{{< cards cols="2" >}}
  ...
  {{< card link="skyhorse" title="🏇天码行空 · SkyHorse" subtitle="📙Bilingual & double-indexed tech blog for data structures & algorithms." image="images/skyhorse_logo.jpg" imageStyle="width: 100%; height: 180px; object-fit: contain; display: block; background: #1e293b;" >}}
{{< /cards >}}
