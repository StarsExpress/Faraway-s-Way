...
## [🎠 SkyHorse Rideshare](https://starsexpress.github.io/Faraway-s-Way/skyhorse/)
After establishing SkyHorse in May 2026, which contains my $O(n)$ double stacks method for
[LeetCode No.2454](https://leetcode.com/problems/next-greater-element-iv/description/),
I suddenly remembered that, in November 2024, I actually already posted the same method in
...
Coincidentally, I found myself having some hard problems' solutions which weren't in LeetCode Wiki at that time,
so everything started at elevating solution of No.2454 from Discussions into PR.
...
• [No.3430 Maximum and Minimum Sums of at Most Size K Subarrays:](https://github.com/doocs/leetcode/pull/5204)
delivered **the repo’s first tutorial for No.3430**, achieving both time and space complexities at **$O(n)$ via deques**.
